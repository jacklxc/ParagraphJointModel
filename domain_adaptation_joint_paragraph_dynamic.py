...
if __name__ == "__main__":
    ...
    argparser.add_argument('--fever_train', type=str, default="/nas/home/xiangcil/scifact/data/fever_train_retrieved.jsonl")
    ...
    argparser.add_argument('--fever_test', type=str, default="/nas/home/xiangcil/scifact/data/fever_dev_retrieved.jsonl")
    ...
    argparser.add_argument('--checkpoint', type=str, default = "domain_adaptation_roberta_joint_paragraph")
