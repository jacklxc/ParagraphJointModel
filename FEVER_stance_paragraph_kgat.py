...
from paragraph_model_kgat import KGATClassifier as JointParagraphClassifier
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--train_file', type=str, default="/home/xxl190027/scifact_data/fever_train_retrieved_15.jsonl")
    argparser.add_argument('--pre_trained_model', type=str)
    #argparser.add_argument('--train_file', type=str)
    argparser.add_argument('--test_file', type=str, default="/home/xxl190027/scifact_data/fever_dev_retrieved_15.jsonl")
    ...
    argparser.add_argument('--checkpoint', type=str, default = "fever_roberta_stance_paragraph_kgat")
    argparser.add_argument('--log_file', type=str, default = "fever_stance_paragraph_kgat_performances.jsonl")
    ...
    with open(args.checkpoint+".log", 'w') as f:
        ...
        if train:
            ...
            for epoch in range(args.epoch):
                ...
                # Evaluation
                subset_train = Subset(train_set, range(0, 100))
                train_score = evaluation(model, subset_train)
                print(f'Epoch {epoch}, train stance f1 p r: %.4f, %.4f, %.4f' % train_score)

                subset_dev = Subset(dev_set, range(0, 100))
                dev_score = evaluation(model, subset_dev)
