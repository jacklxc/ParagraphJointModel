...
from dataset import SciFactStanceDataset as SciFactParagraphBatchDataset
...
if __name__ == "__main__":
    ...
    if test:
        ...
        params["SciFact stance_f1"] = dev_score[0]
        params["SciFact stance_precision"] = dev_score[1]
        params["SciFact stance_recall"] = dev_score[2]
