...
if __name__ == "__main__":
    ...
    argparser.add_argument('--checkpoint', type=str, default = "scifact_roberta_joint_paragraph_kgat.model")
    argparser.add_argument('--log_file', type=str, default = "joint_paragraph_roberta_kgat_dynamic_performances.jsonl")
    ...
    argparser.add_argument('--fine_tune', action='store_true')
    ...
    if train:
        train_set = SciFactParagraphBatchDataset(args.corpus_file, args.train_file, 
                                                 sep_token = tokenizer.sep_token, k = args.k, downsample_n = 2)
    ...
    if args.pre_trained_model is not None:
        ...
        if not args.fine_tune:
            model.reinitialize()    ############
            print("Reinitialized part of the model!")
