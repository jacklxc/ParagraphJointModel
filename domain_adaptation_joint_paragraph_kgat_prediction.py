...
if __name__ == "__main__":
    ...
    argparser.add_argument('--log_file', type=str, default = "domain_adaptation_joint_paragraph_performances.log")
    ...
    argparser.add_argument('--prediction', type=str, default = "prediction_domain_adaptation_roberta_joint_paragraph_kgat.jsonl")
    ...
    dev_set = SciFactParagraphBatchDataset(args.scifact_corpus, args.scifact_test, 
                                           sep_token = tokenizer.sep_token, k = args.scifact_k, train=False)
